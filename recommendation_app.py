...
def user_input_features():
    ...
    market=st.sidebar.selectbox("Choose your supermarket", ['Morrison','Tesco','M&S','Sainsburys','Waitrose'])
    energy_kcal=st.sidebar.slider('Targeted Daily Intake (kcal)', min_value=1000, max_value=6000, step=10)
    days=st.sidebar.slider('Shopping Volume (Days)  (e.g. 6 days)', min_value=3, max_value=7, step=1)
